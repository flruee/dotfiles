...
-- mappings
    vim.keymap.set("n", '<leader>td', function() vim.cmd("Task start cmake debug") end)
    vim.keymap.set("n", '<leader>tr', function() vim.cmd("Task start cmake run") end)
    vim.keymap.set("n", '<leader>tb', function() vim.cmd("Task start cmake build") end)
    vim.keymap.set("n", '<leader>ta', function() vim.cmd("Task start cmake build_all") end)
